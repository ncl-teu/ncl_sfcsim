...
public class CloudUtil {
    ...
    public static int datacenter_externalbw_random = 0;
    public static long datacenter_externalbw = 0;
    ...
    public static int host_bw_random = 0;
    public static long host_bw = 0;
