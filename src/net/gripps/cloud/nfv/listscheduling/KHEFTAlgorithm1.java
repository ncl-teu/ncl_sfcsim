...
public class KHEFTAlgorithm1 extends HEFT_VNFAlgorithm {
    public KHEFTAlgorithm1(CloudEnvironment env, SFC sfc) {
        super(env, sfc);
        setName("KHeft");
    }
    ...
    public void scheduleVNF(VNF vnf, HashMap<String, VCPU> map) {
        ...
        while (cpuIte.hasNext()) {
            ...
            System.out.println(vnf.getWorkLoad());
            System.out.println("fTime"+fTime);
            System.out.println("ret_finishtime"+ret_finishtime);
            ...
            System.out.println("dCompTime" + this.getDLInfo(vnf, cpu));
            System.out.println("est" + est);
            //System.exit(111);
        ...
        System.out.println("retCPU.getDlQueue()" + retCPU.getDlQueue());
