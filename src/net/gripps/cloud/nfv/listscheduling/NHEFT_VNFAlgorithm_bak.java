 ...
 */
public class NHEFT_VNFAlgorithm_bak extends DHEFT_VNFAlgorithm {
    ...
    public NHEFT_VNFAlgorithm_bak(CloudEnvironment env, SFC sfc) {
        super(env, sfc);
    ...
    private DownloadPlan buildPlanFromHost(VNF vnf, VCPU targetVCPU, ComputeHost srcHost, boolean fromRepo, boolean commit) {
        ...
        double start = this.findEarliestPositiveStart(dcSlot, hostSlot);
    ...
    private double findEarliestPositiveStart(BandwidthTimeSlot dcSlot, BandwidthTimeSlot hostSlot) {
    ...
    private DynamicResult simulateDynamicDownload(double startTime,
                                                  long dataSize,
                                                  long maxTransferBW,
